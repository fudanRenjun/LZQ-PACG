...
# 用户输入特征数据
TT = st.number_input("TT(s):", min_value=0.0, max_value=100.0, value=20.1)
MCV = st.number_input("MCV(fl):", min_value=0.0, max_value=200.0, value=98.0)
PDW = st.number_input("PDW(fl):", min_value=0.0, max_value=100.0, value=13.6)
APTT = st.number_input("APTT(s):", min_value=0.0, max_value=100.0, value=36.1)
PT = st.number_input("PT(s):", min_value=0.0, max_value=100.0, value=13.3)
TC = st.number_input("TC(mmol/L):", min_value=0.0, max_value=100.0, value=6.51)
